<?php
// Login endpoint - with MySQL database and single device enforcement
...
try {
    ...
    error_log("✅ Login.php - Database connected - Single device enforcement ACTIVE");
} catch (Exception $e) {
    $databaseEnabled = false;
    error_log("❌ Login.php - Database disabled: " . $e->getMessage());
}
...
error_log("Login.php - Username: $username, Device: $deviceId, Force: " . ($forceLogin ? "Yes" : "No"));

if (!$databaseEnabled) {
    // Fallback to simple authentication without device restriction
    $valid_users = [
        'admin' => 'admin123',
        'user' => 'user123', 
        'test' => 'test123'
